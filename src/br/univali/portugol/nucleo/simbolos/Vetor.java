 ...
 * @version 1.0
 */
public final class Vetor extends Simbolo<NoDeclaracaoVetor>
{
     ...
     * @since 1.0
     */
    public Vetor(String nome, TipoDado tipoDado, NoDeclaracaoVetor declaracaoOrigem)
    {
     ...
     * @since 1.0
     */
    public Vetor(String nome, TipoDado tipoDado, NoDeclaracaoVetor declaracaoOrigem, int tamanho)
    {
     ...
     * @since 1.0
     */
    public Vetor(String nome, TipoDado tipoDado, NoDeclaracaoVetor declaracaoOrigem, int tamanho, List<Object> valores)
    {
     ...
     * @since 1.0
     */
    public Vetor(String nome, TipoDado tipoDado, NoDeclaracaoVetor declaracaoOrigem, List<Object> valores)
    {
        this(nome, tipoDado, declaracaoOrigem);
     ...
     * @param nome o nome deste vetor.
     * @param tipoDado o tipo de dado armazenado por este vetor.
     * @param parametroOrigem o parâmnetro da função que originou o vetor
     * @since 1.0
     */
    public Vetor(String nome, TipoDado tipoDado, NoDeclaracaoParametro parametroOrigem)
    {
     ...
     * @param nome o nome deste vetor.
     * @param tipoDado o tipo de dado armazenado por este vetor.
     * @param parametroOrigem a declaração que originou este vetor
     * @param tamanho o tamamho que este vetor terá.
     * @param valores os valores que serão armazenados neste vetor.
     * @since 1.0
     */
    public Vetor(String nome, TipoDado tipoDado, NoDeclaracaoParametro parametroOrigem, int tamanho, List<Object> valores)
    {
        super(nome, tipoDado, parametroOrigem);
        this.valores = new ArrayList<>(tamanho);
     ...
     * @since 1.0
     */
    public Vetor(String nome, TipoDado tipoDado, NoDeclaracaoParametro parametroOrigem, List<Object> valores)
    {
        super(nome, tipoDado, parametroOrigem);
        this.valores = new ArrayList<>(valores.size());
