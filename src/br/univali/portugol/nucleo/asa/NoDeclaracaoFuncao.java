 ...
 * <p>
 * No Portugol, uma função é tratada como uma declaração para facilitar a implementação do analisador 
 * semântico e do interpretador. Isto também permite que uma função seja acessada globalmente por todas
 * as outras funções, independente da ordem em que aparecem no código fonte, ao contrário do que ocorre
 * na linguagem C, por exemplo.
 * <p>Exemplo de declaração de função:
 * <code><pre>
 *      programa 
 *      {
...
public final class NoDeclaracaoFuncao extends NoDeclaracao
{
     ...
     * @param quantificador     o quantificador do retorno da função (se o tipo de dado retornado for diferente de {@link TipoDado#VAZIO}).
     * @since 1.0
     */    
    ...
    /**
     * Obtém o quantificador do retorno da função (se o tipo de dado retornado for diferente de {@link TipoDado#VAZIO}).
     * Serve para indicar se a função irá retornar um único valor, um vetor ou uma matriz.
     * 
    ...
    /**
     * Obtém a lista de blocos da função. Estes blocos serão executados pelo interpretador do Portugol
     ...
     * 
     * @param blocos     a lista de blocos a serem executados quando esta função for chamada.
     * @since 1.0
     */
    ...
    /**
     * Obtém a lista de parâmetros esperados por esta função. A lista poderá estar vazia 
     * caso a função não necessite de parâmetros.
     * 
