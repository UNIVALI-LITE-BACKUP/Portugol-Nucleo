 ...
 * <p>
 * Um vetor é uma estrutura de dados que armazena vários valores, de forma semelhante
 * a uma lista. No Portugol, os vetores sao declarados colocando o símbolo "[]" após o
 * nome da variável. É possível declarar vetores de várias formas diferentes:
 * 
 * <code><pre>
 * 
...
public final class NoDeclaracaoVetor extends NoDeclaracao
{
     ...
     * @param constante     define se os valores detse vetor serão constantes. Se <code>true</code> os valores
     *                      não poderão ser alterados após a inicialização do vetor.
     * @since 1.0
     */
    ...
    /**
     * Obtém a expressão que define o tamanho, deste vetor, isto é, o número de elementos
     * que ele terá. 
     * 
