 ...
 * No Portugol, as matrizes são declaradas colocando o símbolo "[][]" após o nome
 * da variável. É possível declarar matrizes de várias formas diferentes:
 * 
 * <code><pre>
 * 
...
public final class NoDeclaracaoMatriz extends NoDeclaracaoInicializavel<NoReferenciaMatriz>
{
     ...
     * @param numeroLinhas      a expressão que define o número de linhas desta matriz.
     * @param numeroColunas     a expressão que define o número de colunas desta matriz.
     * @param constante         flag indicando se esta matriz terá valores constantes ou não. Se o valor for <code>true</code> os valores
     *                          da matriz não poderão ser alterados após a inicialização.
     * @since 1.0
     */
    ...
    /**
     * Obtém a expressão que define o número de linhas desta matriz. Pode ser qualquer expressão do tipo {@link TipoDado#INTEIRO}.
     * 
    ...
    /**
     * Obtém a expressão que define o número de colunas desta matriz. Pode ser qualquer expressão do tipo {@link TipoDado#INTEIRO}.
     * 
