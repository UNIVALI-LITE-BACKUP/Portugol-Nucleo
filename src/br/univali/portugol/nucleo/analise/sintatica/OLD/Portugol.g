...
@parser::members
{
	...
	/**
	     * Varre uma cadeia procurando por "sequÃªncias de escape" e substituindo por seus
	     * valores equivalentes.
	     * <p>
	     * As sequÃªncias de escape representam caracteres ou valores especiais que nÃ£o podem
	     * ser escritos diretamente no cÃ³digo-fonte, pois sÃ£o interpretados de forma diferente
	     * pelo parser do Portugol.
	     * 
	     * @param      valor a cadeia em seu formato original, como foi declarada no cÃ³digo fonte.
	     * @return     uma nova versÃ£o da cadeia com as sequÃªncias de escape jÃ¡ substituÃ­das.
	     * 
	     * @since 1.0
	     */
...
tipoPrimitivo returns[NoExpressao expressao] @init
{
	...
	INTEIRO
	{
		...
		catch(NumberFormatException ex)
		{
			...
			a.addSuppressed(new RuntimeException("Caracter invÃ¡lido detectado")); 
		}
	} 
