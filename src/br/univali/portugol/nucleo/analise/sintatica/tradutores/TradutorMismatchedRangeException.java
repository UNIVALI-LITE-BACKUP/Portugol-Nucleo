...
/**
 * Tradutor para erros de parsing do tipo {@link MismatchedRangeException}.
 * 
...
public final class TradutorMismatchedRangeException
{
     ...
     * @since 1.0
     */
    public ErroSintatico traduzirErroParsing(MismatchedRangeException erro, String[] tokens, Stack<String> pilhaContexto, String mensagemPadrao, String codigoFonte)
    {
        int linha = erro.line;
