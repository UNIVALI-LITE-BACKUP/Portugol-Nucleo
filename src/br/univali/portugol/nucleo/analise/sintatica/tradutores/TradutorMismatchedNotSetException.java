...
/**
 * Tradutor para erros de parsing do tipo {@link MismatchedNotSetException}.
 * 
...
public final class TradutorMismatchedNotSetException
{
     ...
     * @since 1.0
     */
    public ErroSintatico traduzirErroParsing(MismatchedNotSetException erro, String[] tokens, Stack<String> pilhaContexto, String mensagemPadrao, String codigoFonte)
    {
        int linha = erro.line;
