...
public class ExemploCorrida extends Programa
{
    ...
    private final int TAXA_ATUALIZACAO = 0;
    ...
    private void atualizar_fps() throws ErroExecucao, InterruptedException
    {
        ...
        if (tempo_fps >= 1000)
        {
            ...
            mediaFPS = totalFPS / iteracoes;

            System.out.println("Variável FPS: " + fps);
            System.out.println("Iterações: " + iteracoes);
            System.out.println("Total FPS: " + totalFPS);
            System.out.println("Média FPS: " + mediaFPS);
            System.out.println("");
        }
    }
